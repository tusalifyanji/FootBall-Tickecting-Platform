...
export default function PaymentSuccess() {
  ...
  try {
    const canvas = await html2canvas(ticket, {
      ...
      useCORS: true, // allow cloudinary images
      backgroundColor: null,
    });

    const link = document.createElement("a");
    link.download = `FAZ-Ticket-${orderId}.png`;
      ...
      <main className="flex-1 container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        {/* TICKET CONTAINER */}
          <div className="w-full max-w-[720px] mx-auto">
            <Card
            id="ticket-container"
            className="relative overflow-hidden rounded-[2.75rem] bg-white shadow-[0_50px_100px_rgba(14,99,61,0.18)] flex flex-col md:flex-row min-h-[260px] border-none"
          >
